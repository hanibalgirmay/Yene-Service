...
public class ChatAppointedUserAdapter extends RecyclerView.Adapter<ChatAppointedUserAdapter.ViewHolder> {
    ...
    public ChatAppointedUserAdapter(Context context, List<ChatModel> mChat, String imageurl){
        this.mChat = mChat;
...
//            if(position == mChat.size() + 1){
            Picasso.get().load(mChat.get(position).getImage()).into(holder.img);
...
//        notifyItemRemoved(position);
    ...
    public void setData(List<ChatModel> messages) {
        this.mChat = messages;
